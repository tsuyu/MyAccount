...
Public Partial Class KemaskiniWangKeluar
	...
	Sub Button4Click(sender As Object, e As EventArgs)
		KemaskiniWangKeluar.ActiveForm.Close
		conn.Open()
		MainForm.comboBox_keluar()
		conn.Close()
		MainForm.show
	End Sub
	...
	Sub KemaskiniWangKeluarLoad(sender As Object, e As EventArgs)
		conn.Open()
		read_data()
		conn.Close()
	End Sub
	...
	Sub Button2Click(sender As Object, e As EventArgs)
		...
		Else
			Try
		 	Dim sqlquery As String = "INSERT INTO transaction_type (tt_name,tt_type) VALUES ('" & textBox1.Text & "','"& "OUT" & "')"
		    Dim cmd As New MySqlCommand
			conn.Open()
		    cmd.CommandText = sqlquery
		    cmd.Connection = conn
